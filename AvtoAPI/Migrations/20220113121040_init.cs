...
namespace AvtoAPI.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "car_owner",
                columns: new[] { "id", "avto_id", "person_id", "registration_date" },
                values: new object[,]
                {
                    { 1, 1, 1, new DateTime(1999, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, 1, 2, new DateTime(2004, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, 1, 3, new DateTime(2005, 6, 22, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 4, 1, 1, new DateTime(2014, 11, 6, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 5, 2, 2, new DateTime(2008, 9, 6, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 6, 3, 4, new DateTime(2002, 4, 16, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
