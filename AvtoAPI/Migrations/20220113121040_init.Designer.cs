            ...
            modelBuilder.Entity("AvtoAPI.Entities.CarOwner", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AvtoId = 1,
                            PersonId = 1,
                            RegistrationDate = new DateTime(1999, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                            AvtoId = 1,
                            PersonId = 2,
                            RegistrationDate = new DateTime(2004, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 3,
                            AvtoId = 1,
                            PersonId = 3,
                            RegistrationDate = new DateTime(2005, 6, 22, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 4,
                            AvtoId = 1,
                            PersonId = 1,
                            RegistrationDate = new DateTime(2014, 11, 6, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 5,
                            AvtoId = 2,
                            PersonId = 2,
                            RegistrationDate = new DateTime(2008, 9, 6, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 6,
                            AvtoId = 3,
                            PersonId = 4,
                            RegistrationDate = new DateTime(2002, 4, 16, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
